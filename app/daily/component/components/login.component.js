...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.loginService.login(this.userName, this.password).subscribe(function (data) { return console.log(data.json()); });
    };
...
LoginComponent = __decorate([
    ...
    __metadata("design:paramtypes", [TestService_1.LoginService])
], LoginComponent);
